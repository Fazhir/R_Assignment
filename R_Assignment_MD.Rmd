...
summary(cars)
```
# delete staff from line 8 to line 20
## Including Plots
...
view(merged_Maize) # do you want to retain this command or it was fro your benefit
```
...
```
# use abs0lute pathway rather than relative
...
```
# view commands may not be very useful 
...
view(Genotypes_SNP)
```
# Hash marks (#) indicate the header levels, # > ## > ####
...
# is this your own work or is part of what you were asked to do.
```{r}
